...
const sets = [
  ...
  S("중식", "월", "Snack", 8800, "분식", [["피자로니떡볶이", 400], ["반죽말이", 200], ["버터갈릭감자튀김", 300], ["단무지", 20], ["탄산음료", 100]], "맛집"),
  S("중식", "화", "Snack", 8800, "한식", [["오징어젓갈볶음밥&후라이", 550], ["미니바지락칼국수", 300], ["새우커틀렛&타르타르", 350], ["양상추샐러드&자몽D", 100], ["저염김치", 15]], "수산물"),
  S("중식", "수", "Snack", 8800, "한식", [["냉김치말이국수", 350], ["김가루양념밥", 350], ["지짐군만두", 250], ["콘샐러드", 120], ["열무김치", 15], ["포기김치", 15]]),
  S("중식", "목", "Snack", 8800, "분식", [["해장라면(신라면)", 500], ["말이반죽", 200], ["치즈볼", 220], ["단무지", 20], ["포기김치", 15]]),
  S("중식", "금", "Snack", 8800, "양식", [["고사리들기름파스타", 500], ["양송이스프", 140], ["갈릭파이", 200], ["양배추샐러드&포도D", 100], ["할라피뇨", 10]], "건강"),
  ...
  S("석식", "월", "Snack", 8800, "분식", [["콩나물라면(진짬뽕)", 500], ["반줄말이", 180], ["갈비만두튀김", 250], ["단무지", 20], ["포기김치", 15]]),
  S("석식", "화", "Snack", 8800, "분식", [["치즈라면(참깨라면)", 520], ["반줄말이", 180], ["아이스홍시", 80], ["단무지", 20], ["포기김치", 15]]),
  S("석식", "수", "Snack", 8800, "분식", [["해물라면(오징어짬뽕)", 520], ["반줄말이", 180], ["테이터팝스&케찹", 250], ["단무지", 20], ["포기김치", 15]]),
  S("석식", "목", "Snack", 8800, "분식", [["토핑선택라면(신라면)", 540], ["반줄말이", 180], ["치킨너겟", 280], ["단무지", 20], ["포기김치", 15]]),
  S("석식", "금", "Snack", 8800, "분식", [["어묵채라면(안성탕면)", 500], ["반줄말이", 180], ["꼬마돈가스", 280], ["단무지", 20], ["포기김치", 15]]),
